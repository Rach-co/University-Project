                    ...
                    <div className="row">
                      <div className="col__6a">
                        ...
                        <div className="row">
                          ...
                          <div className="col__6">
                              <div className="gallery">
                                 <img src={Img1} className="updates__image"/>
                          ...
                          <div className="col__6">
                              <div className="gallery">
                                 <img src={Img2} className="updates__image"/>
                                 <div className="updates__description">
                       ...
                       <div className="col__6"> 
                        ...
                        <div className="gallery">
                            <img src={Img3} className="updates__image"/>
                             <div className="updates__description">
                              A global MBA from the next generation of business leaders                        </div>
                            </div>
                            <div className="updates__more">Read more</div>
                            <div className="updates__date">22 Aug 2022</div>
